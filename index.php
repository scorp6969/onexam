...
<body>
  ...
  <div class="">
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="index.php">ONEXAM</a>
  ...
  <section>
    ...
    <form action="connect.php" , method="POST" class="w-50 m-auto">
  ...
  <footer class="pt-5">
    <p class="p-3 bg-dark text-white text-center">@online-examination-system</p>
  </footer>
